...
export const zhCN: Translations = {
  ...
  welcome: {
    ...
    createYourOwnSkillDescription:
      "创建你的 Agent Skill 来释放美图商业化 aios 的潜力。通过自定义技能，\n它可以帮你搜索网络、分析数据，还能生成报告、网页等作品。",
  },
  ...
  agents: {
    ...
    saving: "正在保存智能体...",
    saveRequested:
      "已提交保存请求，美图商业化 aios 正在根据当前对话生成并保存初版智能体。",
    saveHint:
    ...
    agentCreatedPendingRefresh:
      "智能体已创建，但美图商业化 aios 暂时还无法读取到它。请稍后刷新当前页面。",
    more: "更多操作",
    agentCreated: "智能体已创建！",
    startChatting: "开始对话",
  ...
  channels: {
    ...
    saveChanges: "保存修改",
    descriptions: {
      telegram: "通过 美图商业化 aios Bot 接收 Telegram 私聊消息。",
      slack: "接收 Slack 工作区消息和提及。",
      discord: "通过 美图商业化 aios Bot 接收 Discord 服务器消息。",
      feishu: "通过 美图商业化 aios 应用接收飞书和 Lark 消息。",
      dingtalk: "通过 美图商业化 aios Bot 接收钉钉 Stream Push 消息。",
      wechat: "通过 美图商业化 aios Bot 接收微信 iLink 消息。",
      wecom: "通过 美图商业化 aios AI Bot 接收企业微信消息。",
    },
  ...
  toolCalls: {
    ...
    skillInstallTooltip: "安装技能并使其可在 美图商业化 aios 中使用",
  },
  ...
  shortcuts: {
    ...
    keyboardShortcutsDescription: "使用键盘快捷键更快地操作 美图商业化 aios。",
  ...
  settings: {
    title: "设置",
    description: "根据你的偏好调整 美图商业化 aios 的界面和行为。",
    sections: {
      account: "账号",
      appearance: "外观",
      channels: "渠道",
    ...
    memory: {
      title: "记忆",
      description:
        "美图商业化 aios 会在后台不断从你的对话中自动学习。这些记忆能帮助 美图商业化 aios 更好地理解你，并提供更个性化的体验。",
      empty: "暂无可展示的记忆数据。",
      rawJson: "原始 JSON",
      exportButton: "导出记忆",
      exportSuccess: "记忆已导出",
    ...
    skills: {
      ...
      emptyTitle: "还没有技能",
      emptyDescription:
        "将你的 Agent Skill 文件夹放在 美图商业化 aios 根目录下的 `/skills/custom` 文件夹中。",
      emptyButton: "创建你的第一个技能",
    },
    notification: {
      title: "通知",
      description:
        "美图商业化 aios 只会在窗口不活跃时发送完成通知，特别适合长时间任务：你可以先去做别的事，完成后会收到提醒。",
    ...
    account: {
      ...
      ssoPasswordMessage:
        "此账号通过 {provider} 登录，美图商业化 aios 无法在此管理或修改密码。请前往你的 SSO 提供商账号设置中进行操作。",
  ...
  login: {
    ...
    adminSetupRequiredDescription:
      "美图商业化 aios 需要先创建管理员账号，然后才能创建新的普通账号。",
